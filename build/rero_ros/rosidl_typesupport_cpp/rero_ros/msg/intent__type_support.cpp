...
static const _Intent_type_support_symbol_names_t _Intent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rero_ros, msg, Intent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rero_ros, msg, Intent)),
  }
};
...
{
  return &::rero_ros::msg::rosidl_typesupport_cpp::Intent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rero_ros, msg, Intent)() {
  return get_message_type_support_handle<rero_ros::msg::Intent>();
}
