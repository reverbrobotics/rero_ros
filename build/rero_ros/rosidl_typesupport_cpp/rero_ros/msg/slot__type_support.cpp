...
static const _Slot_type_support_symbol_names_t _Slot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rero_ros, msg, Slot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rero_ros, msg, Slot)),
  }
};
...
{
  return &::rero_ros::msg::rosidl_typesupport_cpp::Slot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rero_ros, msg, Slot)() {
  return get_message_type_support_handle<rero_ros::msg::Slot>();
}
